public class AABBox implements IntersectsRay {
  private Point3 min;
  private Point3 max;

  public AABBox(float xmin, float ymin, float zmin, float xmax, float ymax, float zmax) {
    min = new Point3(xmin, ymin, zmin);
    max = new Point3(xmax, ymax, zmax);
  }

  public Point3 intersection(Ray r) {
