public class Mat4f {
  private float[][] data = new float[4][4];
    ...
    public Point3 multiply(Point3 other) {
      ...
      float newX = data[0][0]*other.x + data[0][1]*other.y + data[0][2]*other.z + data[0][3];
      float newY = data[1][0]*other.x + data[1][1]*other.y + data[1][2]*other.z + data[1][3];
      float newZ = data[2][0]*other.x + data[2][1]*other.y + data[2][2]*other.z + data[2][3];
